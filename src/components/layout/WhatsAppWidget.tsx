  ...
  return (
    <div className="fixed bottom-8 right-8 z-50 group">
      ...
      <a
        ...
        className="relative flex items-center justify-center w-12 h-12 bg-[#25D366] text-white rounded-full shadow-[0_8px_30px_rgb(37,211,102,0.4)] hover:shadow-[0_8px_40px_rgb(37,211,102,0.6)] transition-all duration-500 hover:scale-110 active:scale-95 animate-soft-bounce group-hover:pause-animation"
