    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-light px-4 py-20">
      <div className="w-full max-w-md bg-white p-8 sm:p-10 rounded-3xl shadow-soft border border-gray-100">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <Link href="#" className="text-sm text-brand-primary hover:underline">Forgot password?</Link>
            </div>
            <div className="relative">
        ...
        <p className="text-center text-gray-600 mt-8 text-sm">
          Don't have an account? <Link href="/register" className="text-brand-primary font-semibold hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
