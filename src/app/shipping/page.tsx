...
export default function ShippingPage() {
  return (
    <div className="min-h-screen bg-brand-base pb-20 overflow-hidden">
      ...
      {/* Official Shipping Policy Text */}
      <section className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-16 pb-20">
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-soft border border-neutral-100">
          <h2 className="text-3xl font-serif font-bold text-gray-900 mb-6">Shipping Policy</h2>
