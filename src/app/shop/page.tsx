          ...
          <div className="flex w-full md:w-auto gap-4">
            <div className="relative flex-grow md:flex-grow-0">
              <input 
                ...
                className="w-full md:w-64 pl-10 pr-4 py-2 bg-white border border-gray-200 rounded-full focus:outline-none focus:border-brand-pink focus:ring-1 focus:ring-brand-pink transition-all"
              />
              <Search className="absolute left-3 top-2.5 text-gray-400" size={18} />
            </div>
            <button className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-full hover:border-brand-pink hover:text-brand-pink transition-colors">
              <Filter size={18} />
              ...
              <div key={product.id} className="group flex flex-col">
                <div className="relative overflow-hidden rounded-xl mb-3 aspect-[4/5] bg-gray-100 shadow-sm border border-gray-100 group-hover:shadow-md transition-shadow">
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-2 group-hover:translate-y-0 flex justify-center bg-gradient-to-t from-black/50 to-transparent">
                    <button className="bg-brand-pink/90 backdrop-blur-sm text-white px-4 py-2 w-full rounded-lg text-xs md:text-sm font-medium hover:bg-brand-darkPink transition-colors shadow-sm flex items-center justify-center gap-2">
                      <ShoppingCart size={16} /> Add
                    </button>
                  </div>
                  <button className="absolute top-2 right-2 bg-white/90 backdrop-blur-sm p-1.5 rounded-full text-gray-400 hover:text-brand-pink hover:bg-white transition-all shadow-sm">
                    <Heart size={16} />
                  </button>
                ...
                <div className="flex-1 flex flex-col">
                  <h3 className="text-xs md:text-sm font-medium text-gray-800 hover:text-brand-pink transition-colors leading-snug line-clamp-2">
