    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 text-gray-700">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 flex items-center gap-3">
           <Truck className="w-8 h-8 text-brand-accent p-1 bg-brand-accent/10 rounded-lg border border-brand-accent/20" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-gray-100 rounded-3xl overflow-hidden shadow-soft lg:col-span-1 h-fit">
           <div className="px-6 py-5 border-b border-gray-100 bg-white/50 flex justify-between items-center">
              <h3 className="text-lg font-semibold text-gray-900 flex items-center">
                 <Globe className="w-5 h-5 mr-3 text-brand-accent" /> Active Shipping Ecosystem
              </h3>
           ...
           <div className="p-6">
              {loading ? (
                    ...
                    {zones.map((zone) => (
                       <div key={zone.id} className="p-5 bg-gray-50/30 border border-gray-200 rounded-2xl hover:bg-gray-50/50 transition-colors group relative">
                          ...
                          <div className="flex justify-between items-start mb-3 pr-8">
                             ...
                             <span className="bg-brand-accent/10 text-brand-accent border border-brand-accent/20 px-3 py-1 rounded-lg font-mono text-sm font-bold shadow-sm">
                 ...
                 <div className="p-10 text-center flex flex-col items-center">
                    <Map className="w-12 h-12 text-brand-accent/20 mb-4" />
        ...
        <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-soft lg:col-span-1 h-fit relative">
           ...
           <h3 className="text-lg font-semibold text-gray-900 mb-6 border-b border-gray-100 pb-4 flex items-center">
              <Plus className="w-5 h-5 mr-3 text-brand-accent" /> Create Shipping Profile
           </h3>
           ...
           <form onSubmit={handleAddZone} className="space-y-6">
              <div>
                 ...
                 <input 
                    ...
                    className="w-full px-4 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-brand-accent transition-all text-gray-900 placeholder:text-gray-400"
                 />
              </div>
              ...
              <div>
                 ...
                 <div className="relative">
                    ...
                    <input 
                       ...
                       placeholder="0.00"
                       className="w-full pl-8 pr-4 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-brand-accent transition-all text-gray-900 placeholder:text-gray-400 font-mono"
                    />
                 </div>
              </div>
              ...
              <div className="pt-4 border-t border-gray-100">
                 <button 
                    type="submit" 
                    disabled={saving}
                    className="w-full bg-brand-accent hover:bg-brand-accent/90 disabled:bg-gray-50 disabled:text-gray-400 text-white rounded-xl py-3 font-semibold transition-colors flex justify-center items-center shadow-glow disabled:shadow-none"
                 >
